...
selectYn.addEventListener("click", (event) => {
  // CLICK Y/N
...
inputReady.addEventListener("click", (event) => {
  // RANDOMIZE INPUT
  runInput();
});

selectOutput.addEventListener("click", (event) => {
  // CLICK OUTPUT
  selectScreen.classList.add("invisible");
